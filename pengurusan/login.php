...
if(isset($_POST["btn_username"])) {
    $qry = mysqli_query($con, "SELECT username FROM pengurusan WHERE username='".mres($con,$_POST["username"])."'") or die (mysqli_error($con));
    ...
    $qry = mysqli_query($con, "SELECT password FROM pengurusan WHERE username='".mres($con,$_POST["username"])."' and password='".md5(mres($con,$_POST["password"]))."'") or die (mysqli_error($con));
    if(mysqli_num_rows($qry)>0){
        $_SESSION["pengurusan"]=$_POST["username"];
...
<html lang="en">
  <head>
    ...
    <title>Persada Dunya Distribution Center - Management Department Login Page</title>
    <!-- Bootstrap -->
            ...
            <div id="loginbox" style="margin-top: 50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
               <div class="panel panel-info" style="display: <?php echo $form_username; ?>">
                   <div class="panel-heading">
                       Management User Login: Username
                   </div>
             ...
             <div class="panel panel-info" style="display: <?php echo $form_password; ?>">
                   <div class="panel-heading">
                       Management User Login: Password
                   </div>
                   <div class="panel-body">
