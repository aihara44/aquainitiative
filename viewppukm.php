...
if(isset($_GET["get_id"])){
 ...
 if(isset($_POST["btn_save"])) {
     $comment = mres($con, $_POST["comment"]);
     
     $qry = mysqli_query($con, "INSERT INTO komen_ppukm VALUES ('','".$comment."')");
                   ...
                   <div class="panel-body">
                        <form method="post" class="form-inline" id="form-search" action="<?php echo $_SERVER["PHP_SELF"].(isset(($_GET["get_id"]))?'?get_id='.$_GET["get_id"]:'') ?>">
                            ...
                            <div class="row" style="padding-left: 10px; ">
                                <div style="margin-bottom: 25px" class="input-group">
                                    <span class="input-group-addon">Staff Comments</span>
                                <textarea class="form-control" name="comment" id="comment"></textarea>
                                </div>
                                <div class="form-group">
                                    <button type="submit" class="btn btn-default" id="btn_save" name="btn_save" >Submit</button>
                                </div>
                            </div>
                                <div class="row" style="padding-left: 10px; ">
                                    <div class="form-group">
