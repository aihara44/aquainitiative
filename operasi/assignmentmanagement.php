<?php
    ...
    $qry = mysqli_query($con, "DELETE FROM assignment WHERE assignment_id ='" .mres($con, $_GET["delete_id"])."'");
                    ...
                    <tbody>
                       <?php
                        ...
                        if(isset($_POST["btn_search"])) {
                            $qry = mysqli_query($con, "SELECT * FROM assignment WHERE lect_name LIKE '%".mres($con,$_POST["search_text"])."%' ORDER BY assignment_id asc");
                        }else{
                            $qry = mysqli_query($con, "SELECT * FROM assignment ORDER BY assignment_id asc");
                        }
                        while($row=mysqli_fetch_array($qry,MYSQLI_ASSOC)){
                           ...
                           <td><?php echo $row['size'] ?></td>
                            <td><a href="assignment/<?php echo $row['file'] ?>" target="_blank">view file</a> | <a href= "?delete_id=<?php echo $row ['assignment_id']?>">Delete</a></td>
                            </tr>
                            <?php
                        }
                        ?>
