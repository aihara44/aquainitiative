...
<html lang="en">
  <head>
    ...
    <title>Persada Dunya Distribution Center - Dashboard</title>
    <!-- Bootstrap -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                <h3>Persada Dunya Distribution Center - Dashboard</h3>
            </div>
        </div>
        <div class="row">
         ...
         <div class="row">
          ...
          <div class="col-md-4">
            ...
            <div class="thumbnail">
              ...
              <div class="thumbnail">
              <a href="pengurusan/login.php">
                <img src="management.png" alt="Management" style="width:20%">
              </a>
            </div>
            </div>
